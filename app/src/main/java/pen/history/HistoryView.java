...
public class HistoryView {
    ...
    public HistoryView after(int moment) {
        terms.add(new Term.IncidentFilter(in -> in.moment() >= moment));
        return this;
    }

    public HistoryView before(int moment) {
        terms.add(new Term.IncidentFilter(in -> in.moment() <= moment));
        return this;
    }

    public HistoryView includes(String... entityIds) {
        return includes(List.of(entityIds));
    }

    public HistoryView includes(List<String> entityIds) {
        terms.add(new Term.Includes(new ArrayList<>(entityIds)));
        return this;
    }

    public HistoryView excludes(String... entityIds) {
        return excludes(List.of(entityIds));
    }

    public HistoryView excludes(List<String> entityIds) {
        terms.add(new Term.Excludes(new ArrayList<>(entityIds)));
        return this;
    }

    public HistoryView includeTypes(String... types) {
        return includeTypes(List.of(types));
    }

    public HistoryView includeTypes(List<String> types) {
        terms.add(new Term.IncludesTypes(types));
        return this;
    }

    public HistoryView excludeTypes(String... types) {
        return excludeTypes(List.of(types));
    }

    public HistoryView excludeTypes(List<String> types) {
        terms.add(new Term.ExcludesTypes(types));
        return this;
    }

    public HistoryView boundByEntities(String... entityIds) {
        return boundByEntities(List.of(entityIds));
    }

    public HistoryView boundByEntities(List<String> entityIds) {
