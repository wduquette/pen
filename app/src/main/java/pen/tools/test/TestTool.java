...
/**
 * The implementation of the `pen test` tool.
 */
public class TestTool implements Tool {
    ...
    public static final ToolInfo INFO = new ToolInfo(
        ...
        "Executes Joe tests for Pen's non-JavaFX Joe packages.",
        """
    ...
    private void runTest(String scriptPath) {
        ...
        var joe = new Joe();
        joe.installPackage(new TestPackage(joe.engineName()));

        // Pen-specific packages
